      ...
      success(res) {
        ...
        wx.request({
          ...
          success(res) {
            ...
            wx.request({
              url: 'https://api.gugudata.com/weather/weatherinfo/region?appkey=ZSQZF524BEXA&keyword=' + res.data.Data[0].Province.replace('区', ''),
              header: {
                'content-type': 'application/json'
              },
              success(res) {
                wx.request({
                  url: 'https://api.gugudata.com/weather/weatherinfo?appkey=ZSQZF524BEXA&code=' + res.data.Data[0].Code + '&days=6',
                  header: {
                    'content-type': 'application/json'
                  },
                  success(res) {
